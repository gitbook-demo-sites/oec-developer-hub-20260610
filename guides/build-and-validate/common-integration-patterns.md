...
Write guides around partner goals and link down into [reference pages](https://app.gitbook.com/s/ov7xDc9uLg04p7VFGo2m/README) for contract detail. Do not force developers to learn the product model only from endpoint listings.
